...
process = generate_process(year="2016v5", useData=False)

# Please do not commit changes to source filenames - used for consistency testing
process.source.fileNames = cms.untracked.vstring([
        '/store/relval/CMSSW_10_5_0_pre2/RelValQCD_FlatPt_15_3000HS_13/MINIAODSIM/PU25ns_105X_mcRun2_asymptotic_v1_HS_old-v1/10000/DB279AF3-BAE3-ED44-BCE1-B5EFC05C9B9B.root'
