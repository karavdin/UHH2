...
process = generate_process(year="2018v5", useData=False)

# Please do not commit changes to source filenames - used for consistency testing
process.source.fileNames = cms.untracked.vstring([
      '/store/relval/CMSSW_10_5_0_pre2/RelValQCD_FlatPt_15_3000HS_13/MINIAODSIM/PU25ns_105X_upgrade2018_realistic_v2_HS_old-v1/10000/F5485279-3D51-244B-8827-F9937F5D93B7.root',
...
with open('pydump_mc_2017v5.py', 'w') as f:
